...
@section('toolbar')
    <a class="btn btn-success" href="{{ route('admin.organizations.locations.create', $organization->id) }}">
        ...
        @foreach($locations as $location)
            <li class="list-group-item location">
                <div class="pull-right actions hidden-sm-up">
                    <a href="{{ route('admin.organizations.locations.edit', [$organization->id, $location->id]) }}" class="edit">
