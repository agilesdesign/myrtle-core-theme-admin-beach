...
@section('toolbar')
    {{ Form::button('<i class="fa fa-fw fa-check"></i> Save', ['class' => 'btn btn-success', 'type' => 'submit', 'form' => 'create-organization-location'] ) }}
...
@section('content')
    {{ Form::model($location, ['route' => ['admin.organizations.locations.store', $organization->id], 'id' => 'create-organization-location']) }}
