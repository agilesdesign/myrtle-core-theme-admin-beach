...
@section('toolbar')
    {{ Form::button('<i class="fa fa-fw fa-check"></i> Save', ['class' => 'btn btn-success', 'type' => 'submit', 'form' => 'phone-create'] ) }}
    <a class="btn btn-danger" href="{{ route('admin.vendors.contacts.show', [$vendor, $contact]) }}"><i class="fa fa-fw fa-times"></i> Cancel</a>
@endsection


@section('dock')
    {!! Form::model($phone, ['route' => ['admin.vendors.contacts.phones.store', $vendor, $contact], 'id' => 'phone-create']) !!}
